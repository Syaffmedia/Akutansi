...
<div id="kiri" style="float:left;">
    ...
    <div id="menu1" title="Menu" data-options="iconCls:'icon-tip'"  style="overflow:auto;padding:5px 0px;">
        ...
        <ul class="easyui-tree" >
            ...
            <?php } ?>
            <li data-options="iconCls:'icon-surat_perintah'">
                <a href="<?php echo base_url();?>index.php/rekening">Chart of Account</a>
            </li>
            ...
            <li data-options="iconCls:'icon-surat_keluar'">
                <a href="<?php echo base_url();?>index.php/jurnal_umum">Journal</a>
            </li>
            <li data-options="iconCls:'icon-surat_keluar'">
                <a href="<?php echo base_url();?>index.php/buku_besar">General Ledger</a>
            </li>
            <!--<li data-options="iconCls:'icon-surat_keluar'">
    ...
    <?php } ?>
    <div id="menu2" title="Reports" data-options="iconCls:'icon-print'" style="overflow:auto;padding:5px 0px;">
        <div title="TreeMenu" data-options="iconCls:'icon-search'" style="padding:0px;">
        <ul class="easyui-tree">
            <li>
                <span><a href="<?php echo base_url();?>index.php/lap_buku_besar">General Ledger</a></span>
            </li>
            <li>
                <span><a href="<?php echo base_url();?>index.php/lap_neraca_saldo">Balance Sheet</a></span>
            </li>
            <li>
                <span><a href="<?php echo base_url();?>index.php/lap_neraca_lajur">Trial Balance</a></span>
            </li>
            <li>
                <span><a href="<?php echo base_url();?>index.php/lap_laba_rugi">Profit and Loss Statement</a></span>
            </li>
            <!--<li>
    ...
    <div id="menu3" title="Grafik" data-options="iconCls:'icon-grafik'" style="overflow:auto;padding:5px 0px;">
        ...
        <ul class="easyui-tree">
            <li>
                <span><a href="<?php echo base_url();?>index.php/grafik">Journal</a></span>
            </li>
        </ul>
    </div>
    </div>
